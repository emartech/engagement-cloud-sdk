...
class JSContactTests {
    ...
    @Test
    fun link_shouldDelegate_linkCall() = runTest {
        everySuspend {
            mockContactApi.link(
                CONTACT_FIELD_VALUE
            )
    ...
    @Test
    fun linkAuthenticated_shouldDelegate_linkAuthenticatedContactCall() = runTest {
        everySuspend {
    ...
    @Test
    fun unlink_shouldDelegate_unlinkCall() = runTest {
