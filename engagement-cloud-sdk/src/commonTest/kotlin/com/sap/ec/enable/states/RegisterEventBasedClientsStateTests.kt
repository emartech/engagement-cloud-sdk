...
import com.sap.ec.di.EventBasedClientTypes
...
class RegisterEventBasedClientsStateTests {
    ...
    private lateinit var mockRecommendationClient: EventBasedClientApi
    ...
    fun setUp() {
        ...
        mockRecommendationClient = mock(MockMode.autoUnit)
        clients = listOf(
            mockDeviceClient,
            mockConfigClient,
            mockDeeplinkClient,
    ...
    fun testActive_should_registerAllClients() = runTest {
        ...
        verifySuspend {
            ...
            mockRecommendationClient.register()
        }
