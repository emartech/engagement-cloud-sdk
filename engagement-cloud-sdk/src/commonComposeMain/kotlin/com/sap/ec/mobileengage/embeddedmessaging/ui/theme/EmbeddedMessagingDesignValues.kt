...
import com.sap.ec.mobileengage.embeddedmessaging.ui.EmbeddedMessagingConstants.Image.DEFAULT_IMAGE_CLIP_SHAPE
...
import com.sap.ec.mobileengage.embeddedmessaging.ui.EmbeddedMessagingUiConstants.Dimensions.ZERO_SPACING
import com.sap.ec.mobileengage.embeddedmessaging.ui.EmbeddedMessagingUiConstants.Shapes.ZERO_CORNER_RADIUS
import com.sap.ec.networking.clients.embedded.messaging.model.ShapeCornerRadius

@Immutable
internal data class EmbeddedMessagingDesignValues(
    val messageItemMargin: Dp = DEFAULT_PADDING,
    val messageItemElevation: Dp = ZERO_ELEVATION,
