...
import com.sap.ec.SdkConstants.METRIC_EVENT_NAME
import com.sap.ec.SdkConstants.ON_EVENT_ACTION_ORIGIN
import com.sap.ec.SdkConstants.ON_EVENT_ACTION_REPORTING_EVENT_NAME
import com.sap.ec.SdkConstants.PUSH_CLICKED_EVENT_NAME
import com.sap.ec.SdkConstants.REGISTER_DEVICE_INFO_EVENT_NAME
import com.sap.ec.SdkConstants.REGISTER_PUSH_TOKEN_EVENT_NAME
import com.sap.ec.SdkConstants.REMOTE_CONFIG_UPDATE_REQUIRED_EVENT_NAME
import com.sap.ec.SdkConstants.REREGISTRATION_REQUIRED_EVENT_NAME
import com.sap.ec.SdkConstants.SESSION_END_EVENT_NAME
...
sealed interface SdkEvent {
    ...
    sealed interface DeviceEvent : SdkEvent {
        ...
        fun createDeviceEventFromAttributesMap(attributes: Map<String, String>?): com.sap.ec.networking.clients.event.model.DeviceEvent =
            DeviceEvent(
                type = this.type,
                name = this.name,
        ...
        fun toDeviceEvent(
            ...
            pageLocation: String
        ): com.sap.ec.networking.clients.event.model.DeviceEvent {
    ...
    sealed interface Internal : SdkEvent {
        ...
        sealed interface Reporting : Internal, OnlineSdkEvent, DeviceEventWithCustomAttributes {
            ...
            override fun createDeviceEventFromAttributesMap(attributes: Map<String, String>?): com.sap.ec.networking.clients.event.model.DeviceEvent {
                return DeviceEvent(
                    type = this.type,
                    name = this.name,
                    timestamp = this.timestamp,
